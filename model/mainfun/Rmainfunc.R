...
data = read.csv("E:\\DownloadMusicR\\Musical Analysis\\traindata.csv",header = FALSE)
library(caTools)
...
## random forest_real 
ClaimsTest = read.csv("E:\\DownloadMusicR\\Musical Analysis\\mainfun.csv",header = FALSE)
PredictTest = predict(y, newdata = ClaimsTest, type = "response")
library(car)
...
write.csv(RR, file = "MyData.csv",row.names=FALSE)
